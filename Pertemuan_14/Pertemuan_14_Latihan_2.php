...
echo "<h2>Klik <a href='Pertemuan_14_Latihan_3.php'>di sini 
(Pertemuan_14_Latihan_3.php)</a> untuk LOGOUT</h2>"; 
} else { 
//session belum ada artinya belum login 
die ("Anda belum login! Anda tidak berhak masuk ke halaman 
ini.Silahkan login <a href='Pertemuan_14_Latihan_1.php'>di sini</a>"); 
} 
?>